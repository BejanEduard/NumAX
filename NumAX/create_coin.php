...
<div class="container s-around">
        ...
        <?php include(ROOT_PATH . "/app/includes/messages.php") ?>
            ...
            <div class="form-item">
                ...
                <input type="radio"  name="circulation" value="In Circulation" checked>
                <label for="circulation">Yes</label><br>
                <input type="radio"  name="circulation" value="Not in Circulation">
   ...
   <option value="St-Barts">St Barthelemy</option>
   ...
   <option value="Virgin-Islands">Virgin Islands (USA)</option>
   <option value="Wake-Island">Wake Island</option>
   <option value="Wallis-and-Futana">Wallis & Futana Is</option>
