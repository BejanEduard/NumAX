...
<div class="container s-around">
        ...
        <?php include(ROOT_PATH . "/app/helpers/formErrors.php");  ?>
            ...
            <div class="form-item">
             ...
             <div class="form-item">
                <label class="form-label">Perioada Emisie</label>
                <input type="datetime-local" name="provenience" class="form-input" value="<?php echo $provenience; ?>"required>
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
                ...
                <textarea class="form-input"  name="description" placeholder="Description" form="coin-form" rows="4" value="<?php echo $description; ?>">
                </textarea>
            </div>
